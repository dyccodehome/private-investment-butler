...
READ_CAPABILITIES: dict[str, LongbridgeCapability] = {
    ...
    "candles": LongbridgeCapability(
        ...
        command_prefix=("longbridge", "kline"),
        implemented=True,
    ),
    "market_state": LongbridgeCapability(
        ...
        command_prefix=("longbridge", "market-status"),
        implemented=True,
    ),
    "trading_calendar": LongbridgeCapability(
        capability_id="trading_calendar",
        domain="quote",
        access="read",
        description="读取交易时段和交易日历。",
        command_prefix=("longbridge", "trading"),
        implemented=True,
    ),
    "market_temperature": LongbridgeCapability(
        capability_id="market_temperature",
        domain="quote",
        access="read",
        description="读取市场温度指数。",
        command_prefix=("longbridge", "market-temp"),
        implemented=True,
    ),
    "company_profile": LongbridgeCapability(
        capability_id="company_profile",
        domain="fundamental",
        access="read",
        description="读取公司概况。",
        command_prefix=("longbridge", "company"),
        implemented=True,
    ),
    "valuation": LongbridgeCapability(
        capability_id="valuation",
        domain="fundamental",
        access="read",
        description="读取估值快照和估值历史。",
        command_prefix=("longbridge", "valuation"),
        implemented=True,
    ),
    "financial_report": LongbridgeCapability(
        capability_id="financial_report",
        domain="fundamental",
        access="read",
        description="读取财报摘要、财务报表和财报 AI 速览。",
        command_prefix=("longbridge", "financial-report"),
        implemented=True,
    ),
    "financial_statement": LongbridgeCapability(
        capability_id="financial_statement",
        domain="fundamental",
        access="read",
        description="读取逐行财务报表。",
        command_prefix=("longbridge", "financial-statement"),
        implemented=True,
    ),
    "forecast_eps": LongbridgeCapability(
        capability_id="forecast_eps",
        domain="fundamental",
        access="read",
        description="读取分析师 EPS 预测。",
        command_prefix=("longbridge", "forecast-eps"),
        implemented=True,
    ),
    "consensus": LongbridgeCapability(
        capability_id="consensus",
        domain="fundamental",
        access="read",
        description="读取营收、EBIT、EPS 一致性预测。",
        command_prefix=("longbridge", "consensus"),
        implemented=True,
    ),
    "finance_calendar": LongbridgeCapability(
        capability_id="finance_calendar",
        domain="fundamental",
        access="read",
        description="读取财报、分红、拆股、IPO 和宏观财经日历。",
        command_prefix=("longbridge", "finance-calendar"),
        implemented=True,
    ),
    "news": LongbridgeCapability(
        capability_id="news",
        domain="event",
        access="read",
        description="读取标的资讯列表和资讯搜索结果。",
        command_prefix=("longbridge", "news"),
        implemented=True,
    ),
    "filing": LongbridgeCapability(
        capability_id="filing",
        domain="event",
        access="read",
        description="读取监管申报和交易所披露列表。",
        command_prefix=("longbridge", "filing"),
        implemented=True,
    ),
    "topic": LongbridgeCapability(
        capability_id="topic",
        domain="event",
        access="read",
        description="读取标的相关社区话题和话题搜索结果。",
        command_prefix=("longbridge", "topic"),
        implemented=True,
    ),
