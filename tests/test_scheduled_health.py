...
class ScheduledHealthTest(unittest.TestCase):
    def test_summarize_flags_failures_obsolete_jobs_and_report_gaps(self) -> None:
        ...
        self.assertEqual(len(summary["reports"]["records_missing_longbridge_options_context"]), 1)
    ...
    def test_format_scheduled_health_includes_actionable_sections(self) -> None:
        summary = {
            ...
            "reports": {
                ...
                "records_missing_longbridge_options_context": [{}],
        ...
        self.assertIn("US/ALL 报告缺 longbridge_options_context：1", text)
